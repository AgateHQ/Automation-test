...
By Login_Page_forgot_password= By.linkText("Forgot your password?");			//forgot password link
...
public void Login_Process(String login_email1, String login_password1) {		//enter values to login page elements and hit submit
	driver_Login_Page_Elements.findElement(Login_Page_email).sendKeys(login_email1);
